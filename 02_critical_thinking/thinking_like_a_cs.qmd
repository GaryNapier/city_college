...
![](img/little_engine.png){width=350 height=200 .absolute bottom=50 right=0}
...
- But like recipes, you can't really have intellectual property over code "recipes"*
- Code is displayed publicly for you to use, so use it!

*There are probably exceptions to this, so be careful!

![Jimmy Conway from *Goodfellas*, who "loved to steal"](img/jimmy.png)
